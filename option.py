...
class TrainOption():
    ...
    def __init__(self):
        ...
        parser.add_argument('--test_size', type=int, default=8, help='Set test size')
        ...
        parser.add_argument('--print_iter', type=int, default=1000, help='Set print iter')
...
class TestOption():
    ...
    def __init__(self):
        ...
        parser.add_argument('--image_size', type=int, default=32, help='Set image size')
